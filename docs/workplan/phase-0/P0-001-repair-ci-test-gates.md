...
- Adding an end-to-end scenario suite (`test/e2e`, `make e2e`) — owned by Phase
  1 once run routes bind.
...
|---|---|
| End-to-end scenario suite and `make e2e` | Phase 1 (not yet planned) |
